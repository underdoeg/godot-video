...
```
sudo apt install pkgconf cmake clang libavcodec-dev libavdevice-dev libavfilter-dev libavformat-dev libavutil-dev ffmpeg nasm libvulkan-dev vulkan-tools \
libva-dev libxcb-dri3-dev libvdpau-dev libdrm-dev libx11-xcb-dev libvpx-dev libdav1d-dev libopus-dev liblzma-dev libmp3lame-dev libxfixes-dev libglx-dev libx265-dev libx264-dev \
libaom-dev libbz2-dev libnuma-dev libfdk-aac-dev libvorbis-dev libbz2-dev libglx-dev libgl1-mesa-dev autotools-dev automake libtool
```
...
cd build-integrated
cmake ..
cmake --build . --target libsndfile_external libltc_external
